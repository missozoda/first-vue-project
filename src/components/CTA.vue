<template>
    <section class="bg-neutral-50 py-14">
        <Container>
            <h3 class="font-bold text-neutral-800 md:text-4xl text-2xl mx-auto mb-5">What can us do for you?</h3>
            <p class="md:text-xl text-lg xl:w-2/5 text-neutral-800 mx-auto mb-9">We are ready to work on a project of any complexity, whether it's commercial or residential.</p>
            <div class="xl:mx-80 mx-auto text-start">
                <form @submit.prevent>
                    <div class="sm:grid sm:grid-cols-2 gap-4">
                        ...
                        <textarea class="sm:col-span-2 block w-full mb-2  p-2.5  border border-neutral-100 rounded focus:outline-none focus:border-neutral-300" type="textarea" name="massage" placeholder="Massage" rows="8"></textarea>
                        
                        <span class="col-span-2 text-neutral-500 text-base">* indicates a required field</span>
                        
                        <button @click="submitForm" class="sm:col-span-2 block bg-[#2947A9] text-white rounded py-3 px-24 font-semibold sm:text-lg text-base mx-auto mt-7" type="submit"
                        >Submit</button>
